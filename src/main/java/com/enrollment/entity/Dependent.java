...
public class Dependent implements Serializable {
    ...
    public Dependent(int dependent_Id, String name, String birth_Date, Enrollment enrollee) {
    ...
    public Dependent(String name, String birth_Date, Enrollment enrollee) {
        this.name = name;
        this.birth_Date = birth_Date;
        this.enrollee = enrollee;
    }
    ...
    public Enrollment getEnrollee() {
        return enrollee;
    }

    public void setEnrollee(Enrollment enrolleeToGet) {
